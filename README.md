...
```text
Data Analytics
business questions, KPIs, interpretation, decisions
        |
        v
Analytics Engineering
repeatable transformations, trusted metrics, testing, reporting layers
        |
        v
Data Engineering
...
- public code with reproducible tests;
- a public calculation workbook/presentation with sources;
